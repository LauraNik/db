...
class BaseService(object):
    ...
    def get_entity(self, columns = None, condition=None, order_by = None):
        return self.dao.get_entity(self.model, columns, condition, order_by)

    def get_entities(self, columns = None, condition=None, order_by = None):
        return self.dao.get_entities(self.model, columns, condition, order_by)
